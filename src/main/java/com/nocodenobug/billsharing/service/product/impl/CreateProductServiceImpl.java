...
public class CreateProductServiceImpl implements CreateProductService {
    ...
    @Autowired
    public CreateProductServiceImpl(ProductRepository productRepository, GetCategoryByIdService getCategoryByIdService,
                                    GetProductGroupByIdService getProductGroupByIdService, ModelMapper modelMapper, CloudinaryService cloudinaryService) {
    ...
    public ProductDto createProduct(ProductDto newProduct, MultipartFile file) {
        ...
        newProduct.setPublicImageId(cloudinaryService.uploadImage(file, FolderConstants.PRODUCT_IMAGE_FOLDER));
