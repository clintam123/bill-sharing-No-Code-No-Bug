...
@Tag(
        description = "Order item controller",
        name = "Api về order item")
@RestController
...
public class OrderItemController {
    ...
    public ResponseEntity<?> deleteOrderItem(@PathVariable("id") Long id){
        deleteOrderItemService.deleteOrderItem(id);        return ResponseEntity.ok(DefaultResponse.success("Order item deleted successfully"));
    }
