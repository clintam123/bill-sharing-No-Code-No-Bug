...
public class StatisticsOfVendorTotalOrderDao {
    ...
    public StatisticsOfVendorTotalOrderDto statisticsOfVendorTotalOrder(Long vendorId, String start_date, String end_date) {
        String strQuery =
                " "
                        ...
                        + " WHERE od.vendor_id = :vendorId AND "
                        + " od.updated_at BETWEEN :start_date AND :end_date";
